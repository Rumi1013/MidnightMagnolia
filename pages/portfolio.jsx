			...
			<div className="container">
				...
				<div className="page-hero">
					...
					<p className="hero__subtitle">
						15+ years building programs, securing funding, and leading digital
						operations in nonprofit and technology environments. Available for
						remote roles targeting $100K+ in AI enablement, digital
						transformation, and archival/cultural heritage work.
					</p>
					<div
						style={{
							display: "flex",
				...
				<section
					...
					<p
						className="muted"
						style={{ marginBottom: "var(--space-lg)", maxWidth: "58ch" }}>
						Two ATS-optimized tracks built for $100K+ remote roles. Both current
						as of 2026.
					</p>
					...
					<p
						...
						Additional tracks available (Digital Learning,
						Operations/Compliance, CRM/Tech) — contact for specific versions.
					</p>
				</section>
					...
					<div
						...
						{Object.entries(SKILLS).map(([category, items]) => (
							<div
								className="card"
								key={category}
								style={{ background: "rgba(26,28,46,0.5)" }}>
								<h4
									style={{
					...
					<div className="grid-2">
						{[
							...
							},
							{
								...
								credential:
									"A.A.S. Information Technology (in progress, exp. 2026)",
				...
				<section
					...
					<p
						...
						Available for remote roles in AI enablement, digital transformation,
						and cultural heritage archiving. Also available for consulting
						engagements.
					</p>
					<div
						style={{
