...
Wix Headless remains the CMS/catalog/bookings backend; Next on Vercel is the front door.
...
4. From **`/`**, **`/membership`**, and **`/grimoire`**, confirm Shop CTAs land on Gumroad and membership CTAs on BMAC.
