...
- [ ] Profile photo, bio, brand colors (`dashboard_tasks` `s1`)
- [ ] Free starter (Gentle Beginning or equivalent) live
- [ ] **Magnolia Circle** membership tier ($9/mo) + welcome path (`p4`, `s3`)
- [ ] **Shadow Work Starter Kit** at $9 (`p2`)
- [ ] 3-email welcome for freebie — Day 0, 3, 7 (`s2`)
- [ ] Upsell blocks on product pages (`s4`) — optional week 2
- [ ] 1:1 Creative Strategy Session ($97–$147) when ready (`s5`)
