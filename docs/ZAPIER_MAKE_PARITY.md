...
| **Replaced** | Deprecated (e.g. Patreon-first flows superseded by Gumroad + BMAC) |
| **N/A** | Master Plan row does not apply to current stack |

**Note:** Gumroad / BMAC → Airtable / Notion / Contacts (**Z-01…Z-03**) take priority over legacy Patreon (**P-01…P-03**) while Patreon access is limited.
