...
/** Hero-adjacent spotlight: one bold piece + copy path to booking & catalog */
export const HOME_SPOTLIGHT = {
  ...
  body:
    'The same catalog that dresses this site—magnolia priestess and riverwalk lantern path—backs the work: consulting, digital products, and quiet strategy for neurodivergent creators.',
};
