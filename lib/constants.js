...
export const URLS = {
  ...
  gumroad:   'https://midnightmagnoliasc.gumroad.com/?section=EY25nky0S9sEBStajpDZmw==#EY25nky0S9sEBStajpDZmw==',
  substack:  'https://midnightmagnoliasc.substack.com',
...
export const TOOLS = [
  ...
  { name: 'Substack',         desc: 'Dusk Letters — long-form writing on shadow work, ancestral healing, and soft business.', url: URLS.substack },
  { name: 'Make (Integromat)', desc: 'Visual automation for connecting tools without code. Use alongside Zapier for complex flows.', url: 'https://www.make.com/en/register?pc=midmagsc' },
  { name: 'Zapier',           desc: 'My go-to for simple, fast automations. Connects Airtable, Notion, email, and more.', url: 'https://zapier.com' },
];
