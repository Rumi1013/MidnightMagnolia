...
export const NAV = [
  ...
  /** Primary digital storefront — Buy Me a Coffee (Stan deferred for cost). */
  { label: 'The Shop',      href: URLS.bmac, external: true },
...
export const TOOLS = [
  ...
  { name: 'Buy Me a Coffee',  desc: 'Where digital products and Magnolia Circle membership live (Stan deferred for cost).', url: URLS.bmac },
