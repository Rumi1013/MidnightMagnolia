...
export const URLS = {
  ...
  booking:   '/services',
  /** Deferred (cost) — live URL resolves to Stan /unavailable; never use in CTAs. */
...
// ── Navigation ───────────────────────────────────────────────
// Consulting-first nav: seven links total (six here + the Book a
// Session CTA rendered separately in Layout). Everything else still
// exists as a page — it just isn't competing for top-nav attention:
// Membership lives inside The Sanctuary, Portfolio backs up Work
// With Me, and The Shop / Library / Grimoire consolidate under The
// Sanctuary. Dashboard is intentionally not listed anywhere here —
// it's an internal tool, reachable only by its bookmarked URL.
// `primary: true` marks items shown inline in the top nav; any future
// item added without that flag falls into the "More" menu instead of
// silently growing the primary row again.
export const NAV = [
  { label: 'About',          href: '/about',        primary: true },
  { label: 'Work With Me',  href: '/work-with-me',  primary: true },
  { label: 'Bookings',      href: '/services',      primary: true },
  { label: 'The Sanctuary', href: '/sanctuary',      primary: true },
  { label: 'Blog',          href: '/blog',           primary: true },
  { label: 'Resources',     href: '/resources',      primary: true },
];
...
export const PRODUCTS = [
  ...
  },
  {
    ...
    price: 'Free',
    description: 'Five shadow work prompts, one PDF, no rush. Start here if you’re not sure where else to start.',
    url: URLS.gumroad,
    tag: 'Free',
  },
  {
    ...
    price: '$9',
    description: 'Thirty printable prompts across three arcs — Foundation, Pattern, Return. One PDF, self-paced, no deadline.',
    url: URLS.gumroad,
    tag: 'Start Here',
  },
  {
  ...
  },
  {
    ...
    price: '$49',
    description: 'The Starter Kit + Ancestral Healing Journal + an Integration Guide. Three components, one arc, built to be worked through once and returned to for years.',
    url: URLS.gumroad,
    tag: 'Flagship',
  },
];
...
// ── Services ─────────────────────────────────────────────────
// The three consulting-first homepage offers. Pricing on the first
// entry is sourced from the 90-Day Command Plan flagship-service rate
// card (Digital Organization Session, the real floor of one-on-one
// engagements). AI Literacy Workshops has no published rate yet —
// leave it CTA-based ("Custom pricing") rather than inventing a figure
// until a real number exists to publish.
export const SERVICES = [
  {
    ...
    description:
      'Information governance and knowledge systems strategy, built around how your team actually works — not a template pulled off a shelf.',
    bullets: [
  ...
  },
  {
    ...
    description:
      'Practical, no-jargon sessions for teams adopting AI tools without losing the humans in the process.',
  ...
  {
    id: 'resume-package',
    title: 'Done-For-You Career Docs',
    price: '$29',
    description:
      'Resumes, LinkedIn profiles, and application strategy for people navigating a career pivot — built from someone who’s made a few of her own.',
    bullets: [
...
export const TOOLS = [
  ...
  { name: 'Buy Me a Coffee',  desc: 'Magnolia Circle membership and tips (Stan deferred for cost).', url: URLS.bmac },
];
