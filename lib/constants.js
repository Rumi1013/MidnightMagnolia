...
export const PRODUCTS = [
	...
	},
	{
		...
		price: "$9",
		description:
			"Thirty days of turning inward, one prompt at a time. Structured in three arcs: Foundation, Pattern, Return.",
		url: URLS.stanStore,
		tag: "Start Here",
	},
	{
		...
		price: "$19",
		description:
			"You carry more than you know. A journal rooted in the African diaspora and the American South — for the deep work of lineage healing.",
		url: URLS.stanStore,
		tag: "",
	},
	{
		...
		price: "$9/mo",
		description:
			"Monthly shadow work prompts, a ritual practice, the member edition of Dusk Letters, and community for quiet builders.",
		url: URLS.stanStore,
		tag: "Membership",
	},
	{
		...
		price: "$29",
		description:
			"For neurodivergent creators building a creative practice while healing. Anti-hustle. ADHD-informed. Built for the way your brain actually works.",
		url: URLS.stanStore,
		tag: "",
	},
	{
		...
		price: "$49",
		description:
			"Three components. One uninterrupted arc. The Shadow Work Starter Kit + Ancestral Healing Journal + an exclusive Integration Guide.",
		url: URLS.stanStore,
		tag: "Flagship",
	},
];
...
export const SERVICES = [
	{
		...
		price: "Book a call",
		description:
			"One-on-one systems setup for program managers and nonprofit leaders. We map your workflow, remove the chaos, build structure that holds.",
		bullets: [
			"Career OS setup (Notion + Airtable)",
			"Automation wiring (Zapier)",
	...
	},
	{
		...
		description:
			"Practical AI tools for nonprofits, program managers, and ops leads. Built for people who need to work smarter, not perform productivity.",
		bullets: [
	...
	},
	{
		...
		price: "$29",
		description:
			"Done-for-you ATS-optimized resume suite. Built for $100K+ remote roles in AI enablement and digital transformation.",
		bullets: [
			"2 resume tracks (AI Enablement + Implementation)",
			"Cover letter template",
			"LinkedIn headline + summary copy",
		],
		cta: "Get the Package",
		url: URLS.stanStore,
	},
...
export const CASE_STUDIES = [
	{
		...
		description:
			"Grant writing, compliance management, and funder relationship stewardship for a community justice nonprofit. Managed 12+ funder relationships simultaneously across a 3-year program cycle.",
	...
	},
	{
		...
		description:
			"Designed and directed a reentry education program across 4 sites in 4 counties. Coordinated curriculum development, staffing, and wraparound services for justice-impacted individuals.",
	...
	},
	{
		...
		description:
			"Rebuilt operational workflows using Notion, Airtable, and automation. Reduced administrative overhead and improved cross-team reporting accuracy without adding staff.",
	...
	},
	{
		...
		description:
			"Full budget oversight including forecasting, reconciliation, and reporting to board and funders. Maintained financial compliance across multiple program streams.",
...
export const TOOLS = [
	{
		name: "Notion",
		desc: "My primary workspace for content, projects, and Career OS. Free plan is genuinely good.",
		url: "https://notion.so",
	},
	{
		name: "Canva Pro",
		desc: "Every graphic on this site. The template library alone earns the subscription.",
		url: "https://canva.com",
	},
	{
		name: "Airtable",
		desc: "Where I track jobs, content, and affiliate links. Pair with Zapier for automation.",
		url: "https://airtable.com",
	},
	{
		name: "Amazon Storefront",
		desc: "Books I actually read. Tools I actually use. Journals, tech, and workspace essentials.",
		url: URLS.amazon,
	},
	{
	...
	{
		name: "Stan Store",
		desc: "Where my digital products live. Simple setup, instant delivery, low fees.",
		url: URLS.stanStore,
	},
	{
		name: "Gumroad",
		desc: "No monthly fee. My first launch platform for digital downloads.",
		url: URLS.gumroad,
	},
];
...
export const AMAZON_PICKS = [
	...
	},
	{
		...
		intro:
			"Ink that stays put when journaling, lining art, or annotating proofs. Affiliate links.",
		items: [
			{
	...
	},
	{
		...
		intro:
			"Kindle-friendly truth-telling in the lineage of Black Southern narrative. Affiliate link.",
		items: [
			{
