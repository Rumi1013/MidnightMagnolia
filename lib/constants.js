...
/** Public header: buy, book, look. Logo returns home. Dashboard stays unlinked. */
export const NAV = [
  { label: 'Shop', href: '/shop' },
  { label: 'Book', href: '/services' },
  { label: 'Look', href: '/gallery' },
  { label: 'About', href: '/about' },
];

/** Secondary routes — footer only. */
...
export const PRODUCTS = [
  {
    ...
    url: URLS.gumroad,
    checkout: 'gumroad',
    format: 'PDF, emailed after checkout',
    tag: 'Bestseller',
    artKey: 'Creative Foundations Workbook',
    includes: [
      'Track A Flagship Executive ATS resume',
      'Track B Executive Networking packet',
      'Cover-letter framing for archival and information-governance roles',
    ],
  },
  {
    id: 'workflow-starter',
    ...
    url: URLS.gumroad,
    checkout: 'gumroad',
    format: 'Notion + Airtable templates, emailed after checkout',
    tag: '',
    artKey: 'Creative Foundations Workbook',
    includes: [
      'A Notion workspace you can duplicate',
      'An Airtable base for tracking without a second brain',
      'Short setup notes, not a course',
    ],
  },
  {
    id: 'gentle-beginning',
    ...
    url: URLS.gumroad,
    checkout: 'gumroad',
    format: 'Free PDF, emailed after you leave an address',
    tag: 'Free',
    artKey: 'The Gentle Beginning — Free Shadow Work Starter',
    includes: [
      'Five prompts',
      'One sitting is enough',
      'No sequence you have to finish',
    ],
  },
  {
    ...
    url: URLS.gumroad,
    checkout: 'gumroad',
    format: 'PDF journal, emailed after checkout',
    tag: 'Start Here',
    artKey: 'Shadow Work Starter Kit',
    includes: [
      'Thirty prompts',
      'Three arcs: Foundation, Pattern, Return',
      'Room to write, not a lecture',
    ],
  },
  {
    ...
    format: 'PDF journal, emailed after checkout',
    tag: '',
    artKey: 'Ancestral Healing Journal',
    includes: [
      'Forty prompts',
      'Lineage and reclamation pages',
      'A pace that can hold grief',
    ],
  },
  {
    id: 'magnolia-circle',
    ...
    url: URLS.bmac,
    checkout: 'bmac',
    format: 'Monthly membership on Buy Me a Coffee',
    tag: 'Membership',
    artKey: 'Deep Roots Shadow Work System',
    includes: [
  ...
  },
  {
    ...
    url: URLS.gumroad,
    checkout: 'gumroad',
    format: 'PDF workbook, emailed after checkout',
    tag: '',
    artKey: 'Creative Foundations Workbook',
    includes: [
      'Seven modules',
      'ADHD-informed pacing',
      'Practice pages, not a grind plan',
    ],
  },
  {
    id: 'deep-roots',
    ...
    url: URLS.gumroad,
    checkout: 'gumroad',
    format: 'PDF bundle, emailed after checkout',
    tag: 'Flagship',
    artKey: 'Deep Roots Shadow Work System',
    includes: [
...
export const CASE_STUDIES = [
  {
    id: 'funding',
    metric: 'Grant records',
    label: 'kept honest and on time',
    description:
      'Philanthropic funding work for a statewide community justice nonprofit, with grant compliance, funder reporting, and records systems that kept reporting accurate and on time.',
    tags: ['Grant Compliance', 'Records', 'Nonprofit'],
  },
  {
    id: 'participants',
    metric: 'Statewide',
    label: 'programs documented',
    description:
      'Programs and documentation systems supporting participants across South Carolina — with taxonomy, reporting, and knowledge continuity as the backbone.',
    tags: ['Knowledge Systems', 'Multi-county', 'Community'],
  },
  {
    id: 'digitization',
    metric: 'Case files',
    label: 'moved to digital',
    description:
      'COVID-era digitization of case files and compliance records — taxonomy and metadata standards that improved retrieval and long-term access.',
...
export const FEATURED_PORTFOLIO_CARDS = [
  {
    id: 'publication-design',
    linkKey: 'print',
    title: 'Publication Design — SC State 1890 Catalogs & Commemorative Print',
    summary:
      'Seasonal community-education catalogs designed and produced for SC State 1890, plus commemorative print used with family permission. Covers and selected spreads — not templates.',
    skills:
      'InDesign · Photoshop · Acrobat · editorial layout · press-ready files',
    cta: 'See the print samples',
  },
  {
    id: 'statewide-docs',
    linkKey: 'statewide',
  ...
  },
  {
    ...
    summary:
      'Southern Gothic digital brand and creative archive; Notion knowledge base, structured documentation for educational products, and workflow automation for content calendars and publishing.',
    skills:
