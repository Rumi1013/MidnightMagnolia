...
// ── Navigation ───────────────────────────────────────────────
// `primary: true` items sit directly in the top nav on wide screens;
// the rest live under the "More" menu there (and everywhere in the
// mobile drawer). Kept as one list so the footer's full site map and
// the mobile drawer never fall out of sync with what "More" hides.
export const NAV = [
  ...
  { label: 'The Shop',      href: URLS.gumroad, external: true, primary: true },
