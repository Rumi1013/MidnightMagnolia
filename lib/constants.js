...
export const URLS = {
  ...
  /** Deferred (cost) — keep URL for archive/reference only. */
  ...
  /** Primary digital product storefront. */
  gumroad:   process.env.NEXT_PUBLIC_GUMROAD_URL || 'https://gumroad.com/midnightmagnolia',
